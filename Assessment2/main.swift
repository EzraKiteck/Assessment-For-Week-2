...
//  Assessment2
//
//  Created by Ezra Kiteck on 8/28/18.
...
for i in 0...counter {
    print(i)
    print("The index times 2 is \(i * 2)")
}
...
var animalNames = ["Python", "Swift", "Penguin", "Lion", "Snow Leopard"]

for item in animalNames {
    print(item)
}
...
var optionalCDPlayer: String?

optionalCDPlayer = "Samsung"

if let cdBrand = optionalCDPlayer {
    print("The car has a \(cdBrand) cd player.")
} else {
